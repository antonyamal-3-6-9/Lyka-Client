...
export default function Latest({ latestUnits }) {
  ...
  return (
    <div className="col-lg-6">
      <h3 className="text-dark text-center h4">Latest Products</h3>
      <Carousel
        data-bs-theme="dark"
        interval={1200}
              ...
              <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="d-flex justify-content-center flex-column align-items-center">
                    ...
                    <p>
                      <span className="text-dark">Only </span>
                      <span className="h6 text-dark">{unit.stock}</span>
                      <span className="text-dark"> left</span>
                    </p>
                  </div>
